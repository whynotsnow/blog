...
export function getLive2DCompanionMounted(defaultMounted = true) {
...
export function setLive2DCompanionMounted(mounted: boolean) {
...
export function getLive2DCompanionCollapsed(defaultCollapsed = false) {
...
export function setLive2DCompanionCollapsed(collapsed: boolean) {
	localStorage.setItem(
