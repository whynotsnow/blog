...
export const zh_CN: Translation = {
	...
	[Key.companionShow]: "显示看板娘",
	[Key.companionHide]: "隐藏看板娘",
	...
	[Key.activityCenter]: "动态中心",
	[Key.notifications]: "条通知",
	[Key.markAllRead]: "全部已读",
	[Key.noNotifications]: "暂无通知",
	[Key.noUnreadNotifications]: "没有未读通知",
	[Key.noImportantNotifications]: "没有重要通知",
	[Key.notificationDetails]: "通知详情",
	[Key.notificationSection]: "通知",
	[Key.notificationAll]: "全部",
	[Key.notificationUnread]: "未读",
	[Key.notificationImportant]: "重要",
	[Key.notificationUnreadCount]: "条未读",
	[Key.notificationRead]: "已读",
	[Key.notificationDismiss]: "忽略",
	[Key.notificationAcknowledge]: "我知道了",
	[Key.notificationLater]: "稍后再看",
	[Key.notificationOpen]: "查看通知",
	[Key.readingStatus]: "阅读状态",
	[Key.readingProgress]: "进度",
	[Key.remainingReading]: "预计剩余分钟",
	[Key.currentSection]: "当前章节",
	...
	// 壁纸模式
	[Key.wallBanner]: "横幅模式",
	[Key.wallFullBanner]: "全屏横幅",
	[Key.wallFull]: "全屏壁纸",
	[Key.wallNone]: "隐藏壁纸",
	[Key.settingsPanel]: "显示设置",
	[Key.wallpaperSettings]: "壁纸设置",
	[Key.wallSettings]: "壁纸设置",
	[Key.wallOpacity]: "壁纸透明度",
	[Key.wallBlur]: "壁纸模糊",
