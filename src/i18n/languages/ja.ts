...
export const ja: Translation = {
	...
	[Key.activityCenter]: "アクティビティセンター",
	[Key.notifications]: "件のお知らせ",
	[Key.markAllRead]: "すべて既読にする",
	[Key.noNotifications]: "お知らせはありません",
	[Key.readingStatus]: "読書状況",
	[Key.readingProgress]: "進捗",
	[Key.remainingReading]: "残り時間（分）",
	[Key.currentSection]: "現在のセクション",
	...
	[Key.settingsWallpaperEffects]: "壁紙エフェクト",
