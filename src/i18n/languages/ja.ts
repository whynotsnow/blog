...
export const ja: Translation = {
	...
	[Key.noUnreadNotifications]: "未読のお知らせはありません",
	[Key.noImportantNotifications]: "重要なお知らせはありません",
	[Key.notificationDetails]: "お知らせの詳細",
	[Key.notificationSection]: "お知らせ",
	[Key.notificationAll]: "すべて",
	[Key.notificationUnread]: "未読",
	[Key.notificationImportant]: "重要",
	[Key.notificationUnreadCount]: "件の未読",
	[Key.notificationRead]: "既読",
	[Key.notificationDismiss]: "非表示",
	[Key.notificationAcknowledge]: "了解しました",
	[Key.notificationLater]: "あとで見る",
	[Key.notificationOpen]: "お知らせを開く",
	...
	// 壁紙モード
	[Key.wallBanner]: "バナーモード",
	[Key.wallFullBanner]: "フルスクリーンバナー",
	[Key.wallFull]: "フルスクリーン壁紙",
	[Key.wallNone]: "壁紙を非表示",
	[Key.settingsPanel]: "表示設定",
	[Key.wallpaperSettings]: "壁紙設定",
	[Key.wallSettings]: "壁紙設定",
	[Key.wallOpacity]: "壁紙の透明度",
	[Key.wallBlur]: "壁紙のぼかし",
	[Key.wallCardOpacity]: "カードの透明度",
