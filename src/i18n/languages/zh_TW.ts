...
export const zh_TW: Translation = {
	...
	[Key.activityCenter]: "動態中心",
	[Key.notifications]: "則通知",
	[Key.markAllRead]: "全部已讀",
	[Key.noNotifications]: "暫無通知",
	[Key.noUnreadNotifications]: "沒有未讀通知",
	[Key.noImportantNotifications]: "沒有重要通知",
	[Key.notificationDetails]: "通知詳情",
	[Key.notificationSection]: "通知",
	[Key.notificationAll]: "全部",
	[Key.notificationUnread]: "未讀",
	[Key.notificationImportant]: "重要",
	[Key.notificationUnreadCount]: "則未讀",
	[Key.notificationRead]: "已讀",
	[Key.notificationDismiss]: "忽略",
	[Key.notificationAcknowledge]: "我知道了",
	[Key.notificationLater]: "稍後再看",
	[Key.notificationOpen]: "查看通知",
	[Key.readingStatus]: "閱讀狀態",
	[Key.readingProgress]: "進度",
	[Key.remainingReading]: "預計剩餘分鐘",
	[Key.currentSection]: "目前章節",
	...
	[Key.musicPlayerSequential]: "順序播放",
	...
	// 壁紙模式
	[Key.wallBanner]: "橫幅模式",
	[Key.wallFullBanner]: "全屏橫幅",
	[Key.wallFull]: "全屏壁紙",
	[Key.wallNone]: "隱藏壁紙",
	[Key.settingsPanel]: "顯示設定",
	[Key.wallpaperSettings]: "壁紙設定",
	[Key.wallSettings]: "壁紙設定",
	[Key.wallOpacity]: "壁紙透明度",
	[Key.wallBlur]: "壁紙模糊",
	[Key.wallCardOpacity]: "卡片透明度",
	[Key.wavesAnimation]: "波紋動畫",
	[Key.bannerTitle]: "首頁標題",
