...
| Change categories or tags | `src/services/core/content-store.ts`, `src/services/core/taxonomy.ts`, `src/services/category-page.ts`, category route files |
