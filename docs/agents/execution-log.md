...
After the adjacent planning sidecar was enabled, plan/RM-bound execution records belong in `../blog.sidecar/runs/`. Update this file only for reusable project learning, recurring failure patterns, or lasting maintenance rules. Do not use it as a routine task history or validation transcript.
