...
author: whynotsnow
lang: zh_CN
tags: [测试内容, 功能说明, 站点配置, Astro, Svelte]
category: 测试内容
draft: false
pinned: true
priority: 100
recommendScore: 100
comment: true
alias: fixture-site-feature-guide
---

这篇文章是测试内容功能索引，用于验证博客内容管线、分类页、推荐列表和文章详情的稳定行为。
...
- [测试文章写作与 Frontmatter](/posts/fixture-markdown-writing/)
- [测试 Markdown 扩展语法](/posts/fixture-markdown-extended/)
- [Mermaid 图表写作](/posts/fixture-markdown-mermaid/)
- [测试加密文章能力](/posts/fixture-encrypted-example/)
