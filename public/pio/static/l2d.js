		...
		((r.prototype.getModelMatrix = function () {
			...
			(s.prototype.updateParam = function (t) {
				...
				switch (this.eyeState) {
					...
					case g.STATE_CLOSED:
						((r =
							(e - this.stateStartTime) / this.closedMotionMsec),
							r >= 1 &&
						...
						r
							? ((e[0] = t[0] * i[0] + t[4] * i[1] + t[8] * i[2]),
								...
								(e[12] =
									...
									t[12]),
								(e[1] =
									t[1] * i[0] + t[5] * i[1] + t[9] * i[2]),
								(e[5] =
									t[1] * i[4] + t[5] * i[5] + t[9] * i[6]),
								(e[9] =
								...
								(e[13] =
									...
									t[13]),
								(e[2] =
									t[2] * i[0] + t[6] * i[1] + t[10] * i[2]),
								(e[6] =
									t[2] * i[4] + t[6] * i[5] + t[10] * i[6]),
								(e[10] =
				...
				((at._$yr = !1),
					...
					(mt.prototype.loadShaders2 = function () {
						...
						if (
							...
							return (
								_._$Ji("OffVertex shader compile _$li!"),
								!1
							);
						if (
							...
							return (
								_._$Ji("Fragment shader compile _$li!"),
								!1
							);
						if (
							...
							return (
								_._$Ji("OffFragment shader compile _$li!"),
								!1
							);
						if (
							(t.attachShader(
